...
names(response.plots) <- c("Abra_alba","Ampelisca_spinipes","Arctica_islandica","Crepidula_fornicata","Goniadella_gracilis","Lagis_koreni","Modiolus_modiolus","Sabellaria_spinulosa","assemblage","Richness","Abundance","Evenness","Alpha","Beta","Gamma","TaxDist")
...
output$abund_obs <- renderImage({  #This is where the image is set 
 ...
 #     list(src = "www/cefas&defralogo.png",width ='50%')}
      ...
      list(src = "wwwefftrait datamap-1.png",width ='130%')} 
