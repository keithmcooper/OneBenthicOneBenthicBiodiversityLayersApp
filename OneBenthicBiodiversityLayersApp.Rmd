...
#### REFERENCES ####
 ...
 output$test <-  renderUI({
    ...
    if(as.character(input$layernameInput) == "Assemblages"){
      list(h3("Reference(s)",style=c("color:#044D94")),"Cooper, K. M., Downie, A.-L. and Curtis, M. (2021). North Sea Net Gain (NSNG). Cefas Project Report for The Crown Estate, 34 pp.",br(),br(),
...
"Download layers (model and associated confidence) in shapefile format ", tags$a(href="https://doi.org/10.14466/cefasdatahub.125", "here.")
    ...
    #  list("seven")}
      ...
      list(h3("Reference(s)",style=c("color:#044D94")),"Cooper, K. M., Downie, A.-L. and Curtis, M. (2021). North Sea Net Gain (NSNG). Cefas Project Report for The Crown Estate, 34 pp.")}
       else if(as.character(input$layernameInput) == "Modiolus_modiolus"){
      list(h3("Reference(s)",style=c("color:#044D94")),"Cooper, K. M., Downie, A.-L. and Curtis, M. (2021). North Sea Net Gain (NSNG). Cefas Project Report for The Crown Estate, 34 pp.")}
       else if(as.character(input$layernameInput) == "Ampelisca_spinipes"){
      list(h3("Reference(s)",style=c("color:#044D94")),"Cooper, K. M., Downie, A.-L. and Curtis, M. (2021). North Sea Net Gain (NSNG). Cefas Project Report for The Crown Estate, 34 pp.")}
