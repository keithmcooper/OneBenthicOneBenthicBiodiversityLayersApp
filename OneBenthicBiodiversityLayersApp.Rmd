...
RD$Tax[RD$Tax == 'Abundance']<-"Abundance"
...
"Download layers (model and associated confidence) in shapefile format ", tags$a(href="https://doi.org/10.14466/cefasdatahub.125", "here.")
    ...
    #  list("seven")}
      ...
      list(h3("Reference(s)",style=c("color:#044D94")),"Cooper, K. M., Downie, A.-L. and Thompson, M. Title. Journal. Access the report", tags$a(href="https://www.", "here."))}
      else if(as.character(input$layernameInput) == "Abundance"){
      list(h3("Reference(s)",style=c("color:#044D94")),"Cooper, K. M., Downie, A.-L. and Thompson, M. Title. Journal. Access the report", tags$a(href="https://www.", "here."))}
      else if(as.character(input$layernameInput) == "Evenness"){
      list(h3("Reference(s)",style=c("color:#044D94")),"Cooper, K. M., Downie, A.-L. and Thompson, M. Title. Journal. Access the report", tags$a(href="https://www.", "here."))}
