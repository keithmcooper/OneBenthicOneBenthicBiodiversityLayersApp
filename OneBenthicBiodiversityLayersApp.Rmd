...
#,"font-size: 30px"
 output$desc <-  renderUI({
   ...
   # else if(as.character(input$layernameInput) == "Response"){
    ...
    #  list("seven")}
       else if(as.character(input$layernameInput) == "Response"){list(h3("Description",style=c("color:#044D94")),"This layer shows model predictions based on a k-means clustering of five response traits. As a species’ response to a change in the environment is inherently governed by its response traits, the map shows areas which are theoretically likely to respond differently to a change in environmental conditions (natural or anthropogenic).  Thus, we can use this information to identify areas which are likely to be relatively sensitive or relatively tolerant to a pressure.  The proportional expression of the various response traits categories within each cluster group is presented in a table under the 'Characteristics' tab, and the relative cluster group similarity is shown in the dendrogram below this.")}
