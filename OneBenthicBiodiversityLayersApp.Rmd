...
if(as.character(input$layernameInput) == "Assemblages"){list(h3("Records",style=c("color:#044D94")),p("The spatial distribution of the input data."))}
  ...
  else if(as.character(input$layernameInput) == "Ampelisca_spinipes"){list(h3("Records",style=c("color:#044D94")),p("The spatial distribution of the input data."))}
  ...
  else if(as.character(input$layernameInput) == "Crepidula_fornicata"){list(h3("Records",style=c("color:#044D94")),p("The spatial distribution of the input data."))}
  ...
  else if(as.character(input$layernameInput) == "Abra_alba"){list(h3("Records",style=c("color:#044D94")),p("The spatial distribution of the input data."))}
  else if(as.character(input$layernameInput) == "Lagis_koreni"){list(h3("Records",style=c("color:#044D94")),p("The spatial distribution of the input data."))}
  })
