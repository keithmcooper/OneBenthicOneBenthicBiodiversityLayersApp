...
PSs$Tax[PSs$Tax == 'Abundance']<-"Abundance"
...
OvsPs$Tax[OvsPs$Tax == 'Abundance']<-"Abundance"
...
VIs$Tax[VIs$Tax == 'Abundance']<-"Abundance"
...
"Download layers (model and associated confidence) in shapefile format ", tags$a(href="https://doi.org/10.14466/cefasdatahub.125", "here.")
    ...
    #  list("seven")}
      ...
      list(h3("Reference(s)",style=c("color:#044D94")),"Cooper, K. M., Downie, A.-L. and Thompson, M. Title. Journal. Access the report", tags$a(href="https://www.marinedataexchange.co.uk/details/3573/2022-the-crown-estate-de-rijke-noordzee-cefas-flanders-marine-institute-offshore-wind-evidence-and-change-programme-north-sea-net-gain-project/summary", "here."))}
    else if(as.character(input$layernameInput) == "Sabellaria_spinulosa"){
      list(h3("Reference(s)",style=c("color:#044D94")),"Cooper, K. M., Downie, A.-L. and Curtis, M. (2022). North Sea Net Gain (NSNG). Cefas Project Report for The Crown Estate, 57 pp. Access the report", tags$a(href="https://www.marinedataexchange.co.uk/details/3573/2022-the-crown-estate-de-rijke-noordzee-cefas-flanders-marine-institute-offshore-wind-evidence-and-change-programme-north-sea-net-gain-project/summary", "here."))}
       else if(as.character(input$layernameInput) == "Modiolus_modiolus"){
      list(h3("Reference(s)",style=c("color:#044D94")),"Cooper, K. M., Downie, A.-L. and Curtis, M. (2022). North Sea Net Gain (NSNG). Cefas Project Report for The Crown Estate, 57 pp. Access the report", tags$a(href="https://www.marinedataexchange.co.uk/details/3573/2022-the-crown-estate-de-rijke-noordzee-cefas-flanders-marine-institute-offshore-wind-evidence-and-change-programme-north-sea-net-gain-project/summary", "here."))}
