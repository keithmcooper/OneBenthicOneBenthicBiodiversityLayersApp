...
p("Using the drop-down boxes on the left of the screen, select a category of modelled layer (currently Structure or Species distibution model (SDM)). Next select an individual layer to display.","The map window will then update. On the right of the screen are various tabs for model outputs (see table below).")
...
tabexplan <- data.frame(
  Tab=c("Layer Info",
         "Characteristics",
               ...
               "Confidence"),
  Explanation=c("Description of the modelled layer, a reference (if appropriate) and details of funders or partners involved in the production of the layer",
...
#### REFERENCES ####
 ...
 output$test <-  renderUI({
    ...
    if(as.character(input$layernameInput) == "Assemblages"){
      list(h3("Reference(s)",style=c("color:#044D94")),"Cooper, K. M., Downie, A.-L. and Curtis, M. (2021). North Sea Net Gain (NSNG). Cefas Project Report for The Crown Estate, 56 pp. Access the report", tags$a(href="https://www.cefas.co.uk/data-and-publications/publications/search/#/search", "here."),br(),br(),
...
"Download layers (model and associated confidence) in shapefile format ", tags$a(href="https://doi.org/10.14466/cefasdatahub.125", "here.")
    ...
    #  list("seven")}
      ...
      list(h3("Reference(s)",style=c("color:#044D94")),"Cooper, K. M., Downie, A.-L. and Curtis, M. (2021). North Sea Net Gain (NSNG). Cefas Project Report for The Crown Estate, 56 pp. Access the report", tags$a(href="https://www.cefas.co.uk/data-and-publications/publications/search/#/search", "here."))}
       else if(as.character(input$layernameInput) == "Modiolus_modiolus"){
      list(h3("Reference(s)",style=c("color:#044D94")),"Cooper, K. M., Downie, A.-L. and Curtis, M. (2021). North Sea Net Gain (NSNG). Cefas Project Report for The Crown Estate, 56 pp. Access the report", tags$a(href="https://www.cefas.co.uk/data-and-publications/publications/search/#/search", "here."))}
       else if(as.character(input$layernameInput) == "Ampelisca_spinipes"){
      list(h3("Reference(s)",style=c("color:#044D94")),"Cooper, K. M., Downie, A.-L. and Curtis, M. (2021). North Sea Net Gain (NSNG). Cefas Project Report for The Crown Estate, 56 pp. Access the report", tags$a(href="https://www.cefas.co.uk/data-and-publications/publications/search/#/search", "here."))}
...
plotOutput('parrespcur', width = '85%', height = '80%') 
```
</div>
